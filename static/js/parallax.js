...
var paraSample = {}, utilLib = {},
  ...
  windowWidth, windowHeight, windowAspect, baseFontSize, para, wheelstep, aRCDescript, /*
 ...
 */
  ...
  iPadMode = navigator.userAgent.match(/iP/i), supportsTouchEvents = ('ontouchstart' in document.documentElement) || ( /Android|webOS|iPhone|iPad|iPod|BlackBerry|Windows Phone|ZuneWP7/i.test(navigator.userAgent) );
...
paraSample.settings = {
  ...
  touchNotScrollMode: (utilLib.deviceDescription.type != utilLib.DEVICE_TYPES.desktop) && utilLib.deviceDescription.touchCapable,
...
function parallax(param) {
  ...
  function slide($src, masterSlide, prnt) {
    ...
    this.adjust = function() {
      ...
      if ((toTheLeftOfScreen || toTheRightOfScreen) && !param.noSlideHideOptimization) {
